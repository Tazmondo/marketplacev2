...
function Thumbs.GetBundle(bundleId: number, resolution: BundleResolution?)
	return `rbxthumb://type=BundleThumbnail&id={bundleId}&w={resolution or "420"}&h={resolution or "420"}`
end
